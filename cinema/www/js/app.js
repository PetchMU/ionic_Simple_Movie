...
.run(function($ionicPlatform,$cordovaSQLite) {
  $ionicPlatform.ready(function() {
	...
	$cordovaSQLite.execute(db,`DELETE FROM Movies`)
		...
		VALUES(?,?,?,?,?,?,?)`,["The Boss Baby","A suit-wearing briefcase-carrying baby pairs up with his seven-year old brother to stop the dastardly plot of the CEO of Puppy Co.",
		'Animation',97,'2017-03-30',"img/cover/The Boss Baby.jpg", "tquIfapGVqs"])
		...
		$cordovaSQLite.execute (db, `INSERT INTO Movies (Title,Detail,Category,Length,ReleaseDate,Image, Youtube)
		VALUES(?,?,?,?,?,?,?)`,['Beauty and the Beast','Belle, whose father is imprisoned by the Beast, offers herself instead, unaware her captor to be an enchanted prince.',
		'Adventure / Fantasy',129,'2017-03-16',"img/cover/Beauty and the Beast.jpg", "OvW_L8sTu5E"])
	...
	$cordovaSQLite.execute(db,`INSERT INTO Users(Email,Password,BirthDate) VALUES 
	(?,?,?)`,["chomview3@hotmail.com","029450955","1995-10-03"])
	...
	.state('tab.promotion', {
		...
		views: {		// หน้าตาที่จะเอามาแสดง
			't-promotion': {
				...
				controller: 'PromotionCtrl'			// controller ที่เอามาใช้กับtabนี้    -- 1page1 controller
			}
		}
	})  //1ตัว จะทำอันใหม่ก็อบถึงตรงนี้  
